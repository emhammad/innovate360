          ...
          <div className="mb-3 position-relative">
            <input
              ...
              style={{
                ...
                opacity: 1,
                borderWidth: '1px',
                border: fieldErrors.name ? '1px solid #dc3545' : '1px solid #3D3D3D40',
          ...
          <div className="mb-3">
            <PhoneInput
              ...
              inputStyle={{
                ...
                opacity: 1,
                borderWidth: "1px",
                border: fieldErrors.phone ? "1px solid #dc3545" : "1px solid #3D3D3D40",
                background: "transparent",
                fontSize: "14px"
              }}
              buttonStyle={{
            ...
            <div className="position-relative">
              <input
                ...
                style={{
                  ...
                  opacity: 1,
                  borderWidth: '1px',
                  border: fieldErrors.password ? '1px solid #dc3545' : '1px solid #3D3D3D40',
                  background: 'transparent',
                  fontSize: '14px'
                }}
              />
